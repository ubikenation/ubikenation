          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const Icon(Icons.pedal_bike, color: AppTheme.primary, size: 56),
                const SizedBox(height: 8),
                const Text('U-Bike',
                    textAlign: TextAlign.center,
                    style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: AppTheme.ink)),
                ...
                TextButton(
                  ...
                  child: Text(_isLogin ? 'New here? Create an account' : 'Have an account? Log in'),
                ),
              ],
            ),
          ),
