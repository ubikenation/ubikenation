...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  final _bikeType = ValueNotifier<String>('Standard Bike');
        ...
        content: Column(
          children: [
            ValueListenableBuilder<String>(
              valueListenable: _bikeType,
              builder: (_, value, _) => DropdownButtonFormField<String>(
                initialValue: value,
                decoration: const InputDecoration(labelText: 'Bike Type'),
                items: const [
                  DropdownMenuItem(value: 'Standard Bike', child: Text('Standard Bike')),
                  DropdownMenuItem(value: 'Electric Bike', child: Text('Electric Bike')),
                ],
                onChanged: (v) => _bikeType.value = v ?? 'Standard Bike',
              ),
            ),
            const SizedBox(height: 10),
  ...
  String _label(String key) => switch (key) {
        ...
        'vehicle_photo_url' => 'Bike Photo',
        'ownership_proof_url' => 'Bike Ownership Proof',
