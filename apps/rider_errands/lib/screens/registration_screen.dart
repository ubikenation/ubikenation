...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  final _transport = ValueNotifier<String>('Motorbike');

  // Documents captured (placeholder storage paths; real upload via Supabase Storage).
  // Errands rider required documents (matches backend REQUIRED_DOCS['errands']).
            ...
            ValueListenableBuilder<String>(
              ...
              builder: (_, value, _) => DropdownButtonFormField<String>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(value: 'On Foot', child: Text('On Foot')),
                ],
                onChanged: (v) => _transport.value = v ?? 'Motorbike',
              ),
            ),
            const SizedBox(height: 10),
            TextField(controller: _plate, decoration: const InputDecoration(labelText: 'Plate / ID (optional)')),
          ],
        ),
      ),
      Step(
