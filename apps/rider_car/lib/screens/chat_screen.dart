...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _load() async {
    try {
      final d = await context.read<ApiClient>().get('/api/trips/${widget.tripId}/chat') as List<dynamic>;
      if (mounted) setState(() => _messages = d.cast<Map<String, dynamic>>());
  ...
  Future<void> _send() async {
    ...
    try {
      final res = await api.post('/api/trips/${widget.tripId}/chat', {'body': text}) as Map<String, dynamic>;
      _ctrl.clear();
      await _load();
