...
import 'package:ubike_rider_car/models/models.dart';
...
void main() {
  ...
  test('FeeQuote infers payment requirement from fee', () {
    ...
    final paid = FeeQuote.fromJson({'isFounding': false, 'registrationFee': 4000, 'slotsRemaining': 0});
    expect(paid.paymentRequired, isTrue);
    expect(paid.registrationFee, 4000);
  });
}
